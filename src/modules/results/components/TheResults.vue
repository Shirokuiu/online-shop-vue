      ...
      <li class="results__item product">
        ...
        <div class="product__image">
          ...
          <img
            ...
            srcset="@/assets/img/item1-2x.jpg 2x"
            width="318"
            height="220"
          ...
          <div class="product__image-navigation">
            <span
              class="product__navigation-item product__navigation-item--active"
            ></span>
      ...
      <li class="results__item product">
        ...
        <div class="product__image">
          ...
          <img
            ...
            srcset="@/assets/img/item2-2x.jpg 2x"
            width="318"
            height="220"
      ...
      <li class="results__item product">
        ...
        <div class="product__image">
          ...
          <img
            ...
            srcset="@/assets/img/item3-2x.jpg 2x"
            width="318"
            height="220"
      ...
      <li class="results__item product">
        ...
        <div class="product__image">
          ...
          <img
            ...
            srcset="@/assets/img/item4-2x.jpg 2x"
            width="318"
            height="220"
      ...
      <li class="results__item product">
        ...
        <div class="product__image">
          ...
          <img
            ...
            srcset="@/assets/img/item5-2x.jpg 2x"
            width="318"
            height="220"
      ...
      <li class="results__item product">
        ...
        <div class="product__image">
          ...
          <img
            ...
            srcset="@/assets/img/item6-2x.jpg 2x"
            width="318"
            height="220"
